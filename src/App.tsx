...
function App() {
  ...
  const products: Product[] = [
    ...
    {
      id: 12,
      name: 'Чоловіча вишиванка. Гетьман 1',
  ...
  'https://i.ibb.co/HfBYy3f5/getman4.png'
    ...
    {
      id: 13,
      name: 'Чоловіча вишиванка. Гетьман 2',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Темно-синій',
      sleeveLength: 'Універсал',
  ...
  'https://i.ibb.co/WvkP5bym/photo-2025-11-03-14-39-35-removebg-preview.png'
    ...
    {
      id: 14,
      name: 'Чоловіча вишиванка. Гетьман 3',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Темно-синій',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/BH5Jtkys/getman31.png'
    ...
    {
      id: 15,
      name: 'Чоловіча вишиванка. Гетьман 4',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Темно-синій',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/zhwzFC6S/getman43.png'
    ...
    {
      id: 16,
      name: 'Чоловіча вишиванка. Козацька 1',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
...
'https://i.ibb.co/VpN3HWGQ/cossacks33.png'
    ...
    {
      id: 19,
      name: 'Чоловіча вишиванка. Козацька 4',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Насичений блакитний',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/99d0W5fF/cossacks41.png'
    ...
    {
      id: 20,
      name: 'Чоловіча вишиванка. Отаман 1',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
...
'https://i.ibb.co/4Zc5QX3f/otaman2.png'
    ...
    {
      id: 21,
      name: 'Чоловіча вишиванка. Отаман 1с',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий з синім',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/NHkjwFS/otaman4s.png'
    ...
    {
      id: 22,
      name: 'Чоловіча вишиванка. Отаман 1ч',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
...
'https://i.ibb.co/1D0HcMG/otaman3ch.png'
    ...
    {
      id: 23,
      name: 'Чоловіча вишиванка. Отаман 2c',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий з синім',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/twbZNnmv/otaman21s.png'
    ...
    {
      id: 24,
      name: 'Чоловіча вишиванка. Отаман 2ч',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий з червоним',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/ZR1L080q/otaman23ch.png'
    ...
    {
      id: 25,
      name: 'Чоловіча вишиванка. Отаман 3',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/Ld1fKbxQ/otaman33.png'
    ...
    {
      id: 26,
      name: 'Чоловіча вишиванка. Отаман 4',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
...
'https://i.ibb.co/0Rhz7tWF/otaman43.png'
    ...
    {
      id: 27,
      name: 'Чоловіча вишиванка. Степова 1',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий з синім',
      sleeveLength: 'Універсал',
...
'https://i.ibb.co/8gyLXdn8/stepova21s.png'
    ...
    {
      id: 29,
      name: 'Чоловіча вишиванка. Степова 2ч',
      sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
      fabric: 'Домоткане полотно. 50% льону, 50% бавовна',
      color: 'Білий з червоним',
      sleeveLength: 'Універсал',
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 text-amber-100">
              ...
              >
                ...
                <span className="hidden md:inline text-sm">098 030 27 00</span>
              </a>
              <a
                href="tel:+380960941922"
                className="flex items-center gap-2 hover:text-white transition-colors"
                title="Зателефонувати"
              >
                <Phone className="w-4 h-4" />
                <span className="hidden md:inline text-sm">096 094 19 22</span>
              </a>
              <a
